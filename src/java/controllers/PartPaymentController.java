 ...
 * @author boc
 */
public class PartPaymentController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(ArticleDetailsObj==null || td==null){
            request.setAttribute("validationMessage", "PartPaymentErr");
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("partPayment.jsp");
            dispatcher.forward(request, response);
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(PartPaymentController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
