 ...
 * @author boc
 */
public class TicketInquiryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(ArticleDetailsObj==null || td==null){
            request.setAttribute("validationMessage", "TicketInquiryErr");
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("ticketInquiry.jsp");
            dispatcher.forward(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(TicketInquiryController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
