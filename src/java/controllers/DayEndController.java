...
public class DayEndController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String result  = bdp.dayEnd(Sequence);
        if(result.equals("success")){
            
            
            PrintWriter out = response.getWriter();  
            request.setAttribute("validationMessage", "DayEndSuccess");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DayEndController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
