                        ...
                        <div class="col-sm-6">
                            ...
                            <table class="table">
                                <tbody >
                                    <tr>
                                      <td>Interest Due</td>
                                      <td><%=priceFormatter.format(Double.parseDouble(td.getInterestDue())) %></td>
                                    </tr>

                                    <tr>
                                    <td>Capital Due</td>
                                      <td><%=priceFormatter.format(Double.parseDouble(td.getBalanceamount())) %></td>
                                    </tr>
                                    <%
                                    ...
                                    <tr>
                                      <td><b>Total Due</b></td>
                                      <td><b><%=priceFormatter.format(total) %></b></td>
                                    </tr>
                                </tbody>
                            </table>
                            </div>
